...
-- MAIN
createToggle("Auto Stab", tabContents["MAIN"], false)
createToggle("Speed on Kill", tabContents["MAIN"], false)
createToggle("Invisibility", tabContents["MAIN"], false)
createBigButton("🔪 KILL ALL", tabContents["MAIN"], Color3.fromRGB(120, 30, 30))

createToggle("Murder Shot", tabContents["MAIN"], false)
createToggle("Auto Aim", tabContents["MAIN"], false)
createToggle("Fast Reload", tabContents["MAIN"], false)
createBigButton("🔫 MURDER SHOT", tabContents["MAIN"], Color3.fromRGB(30, 50, 160))
...
createSlider("Range", tabContents["ESP"], 50, 300, 150)
